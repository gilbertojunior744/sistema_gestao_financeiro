        ...
        <aside class="left-sidebar">
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <p><b>Sistema de Gestão Financeiro</b></p>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/sistema_gestao_financeiro/categoriaTransacoes/listar" aria-expanded="false">
                                <span>
                                    <iconify-icon icon="solar:home-smile-bold-duotone" class="fs-6"></iconify-icon>
                                </span>
                                <span class="hide-menu">Categoria de Transações</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/sistema_gestao_financeiro/contasBancarias/listar" aria-expanded="false">
                                <span>
                                    <iconify-icon icon="solar:home-smile-bold-duotone" class="fs-6"></iconify-icon>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./index.html" aria-expanded="false">
                                ...
                                <span class="hide-menu">Transações Financeiras</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./index.html" aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./index.html" aria-expanded="false">
                                ...
                                <span class="hide-menu">Relatórios Financeiros</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./index.html" aria-expanded="false">
